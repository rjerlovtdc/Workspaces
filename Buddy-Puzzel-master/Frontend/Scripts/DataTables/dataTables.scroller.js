...
$.extend( Scroller.prototype, {
	 ...
	 * a given row
	 *  @param {number} iRow Row number to calculate the position of
	 *  @returns {int} Pixels
	 *  @example
	 *    $(document).ready(function() {
	 *      $('#example').dataTable( {
	 ...
	 *  @param {number} iPixels Offset from top to calculate the row number of
	 *  @param {number} [intParse=true] If an integer value should be returned
	 *  @param {number} [virtual=false] Perform the calculations in the virtual domain
	 ...
	 *  @param {number} iRow Row index to scroll to
