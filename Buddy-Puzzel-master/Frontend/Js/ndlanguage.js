...
/* Global Variables */
versionObj.ndlanguage = 37;


/**
 * @typedef {object} ndErrorCodes
 * @property {string} NOT_ALLOWED - "Ikke tilladt"
 * @property {string} SESSION_NOT_FOUND - "Intet aktivt kald"
 * @property {string} INVALID_ARGUMENT - "Ugyldigt nummer"
*/
const ndErrorCodes = {
    "NOT_ALLOWED": "Ikke tilladt",
    "SESSION_NOT_FOUND": "Intet aktivt kald",
    "INVALID_ARGUMENT": "Ugyldigt nummer",
    "": ""
};


/**
 * @typedef {object} searchInDic
 * @property {string} all - "Alle"
 * @property {string} name - "Navn"
 * @property {string} firstName - "Fornavn"
 * @property {string} lastName - "Efternavn"
 * @property {string} info - "Søgeord"
 * @property {string} departmentName - "Afdeling"
 * @property {string} organizationName - "Forvaltning"
 * @property {string} searchPhrases - "Søgeord"
 * @property {string} searchWords - "Søgeord"
 * @property {string} services - "Vejnavn"
 * @property {string} streetAddress - "Vejnavn"
...
const searchInDic = {
    ...
    "organizationName": "Forvaltning",
    "searchPhrases": "Søgeord",
    "searchWords": "Søgeord",
    "services": "Vejnavn",
...
/**
 * @typedef {object} searchInTxtToNum
 * @property {string} all - 0
 * @property {string} name - 2
 * @property {string} info - 3
 * @property {string} departmentName - 1
 * @property {string} organizationName - 1
 * @property {string} searchPhrases - 3
 * @property {string} searchWords - 3
 * @property {string} services - 5
 * @property {string} streetAddress - 5
 * @property {string} title - 4
*/
const searchInTxtToNum = {
    "all": 0,
    "name": 2,
    "info": 3,
    "departmentName": 1,
...
const aggStatusDic = {
    "-1": {
        title: "Ukendt", color: "ndColorGray"
    },
    "": {
        title: "Ukendt", color: "ndColorGray"
    },
    "0": {
        title: "Ledig", color: "ndColorGreen"
    },
    "1": {
        title: "Måske ledig", color: "ndColorYellow"
    },
    "2": {
        title: "Optaget", color: "ndColorRed"
    }
}
...
const paStatusDic = {
    "": {
        title: "Ikke aktiv", color: "ndColorGray", state: "-1"
    },
    "NotEnabled": {
        title: "Ukendt", color: "ndColorGray", state: "-1"
    },
    "Business Trip": {
        title: "På forretningsrejse", color: "ndColorYellow", state: "1"
    },
    "Gone for the Day": {
        title: "Gået for idag", color: "ndColorRed", state: "2"
    },
    "Lunch": {
        title: "Til frokost", color: "ndColorYellow", state: "1"
    },
    "Meeting": {
        title: "I møde", color: "ndColorRed", state: "2"
    },
    "None": {
        title: "Ikke aktiv", color: "ndColorGreen", state: "0"
    },
    "Out Of Office":
    {
        title: "Ikke på kontoret", color: "ndColorGray", state: "-1"
    },
    "Temporarily Out": {
        title: "Midlertidigt ikke til stede", color: "ndColorYellow", state: "1"
    },
    "Training": {
        title: "På kursus", color: "ndColorRed", state: "2"
    },
    "Unavailable": {
        title: "Kan ikke træffes", color: "ndColorRed", state: "2"
    },
    "Vacation": {
        title: "Holder ferie", color: "ndColorRed", state: "2"
    }
}
...
const teamsAvailability = {
    ...
    "Offline": {
        title: "Offline", color: "ndColorGray", state: "-1"
    },
    "Available": {
        title: "Ledig", color: "ndColorGreen", state: "0"
    },
    "AvailableIdle": {
        title: "Ledig", color: "ndColorGreen", state: "0"
    },
    "Away": {
        title: "Væk", color: "ndColorYellow", state: "1"
    },
    "BeRightBack": {
        title: "Straks tilbage", color: "ndColorYellow", state: "1"
    },
    "Busy": {
        title: "Optaget", color: "ndColorRed", state: "2"
    },
    "BusyIdle": {
        title: "Optaget Ledig", color: "ndColorRed", state: "2"
    },
    "DoNotDisturb": {
        title: "Forstyr Ikke", color: "ndColorRed", state: "2"
    },
    "Inactive": {
        title: "Logget af", color: "ndColorGray", state: "-1"
    },
    "PresenceUnknown": {
        title: "Ukendt", color: "ndColorGray", state: "-1"
    }
...
const teamsActivity = {
    ...
    "AvailableIdle": "Ledig",
    "Away": "Væk",
    "BeRightBack": "Straks tilbage",
    "Busy": "Optaget",
    "DoNotDisturb": "Forstyr Ikke",
    "InACall": "Samtale",
    "Inactive": "Inaktiv",
    "InAConferenceCall": "Konference",
    "InAMeeting": "I møde",
    "Offline": "Offline",
    "OutOfOffice": "Ude af kontoret",
    "OffWork": "Fri",
    "Presenting": "Præsenterer",
    "PresenceUnknown": "Ukendt",
    "UrgentInterruptionsOnly": "Kun vigtige"
};


const custGroupIdToName = {
    14: "AMH",
    15: "BFH",
    11: "BOH",
    19: "CEJ",
...
const teamsLoginErrorTexts = {
    "DA": {
        "interaction_in_progress": {
            "Title": "Microsoft Teams Login",
            "ErrorText": "Login vindue er åbent i en anden fane ..",
            "Name": "BrowserAuthError"
        }
    },
    "EN": {
        "interaction_in_progress": {
            "Title": "Interaction in progress",
            "ErrorText": "Interaction is currently in progress. Please ensure that this interaction has been completed before calling an interactive API.  For more visit: aka.ms/msaljs/browser-errors",
            "Name": "BrowserAuthError"
        }
    }
}